...
import CV from "../assets/soumojit.pdf";
const Navbar = () => {
  ...
  return (
    <div>
      ...
      >
        ...
        <a href={CV} download={"soumojit.pdf"}  className="md:text-base lg:text-lg bg-purple-500 hover:bg-purple-400 text-white px-4 py-2 rounded-full">
          Downlaod CV
        </a>
      </motion.div>
